...
import { Award, BookOpen, Wallet, ChevronRight } from 'lucide-react-native'
    ...
    <ScrollView className="flex-1 bg-bg-card2 px-5 py-6">
      ...
      <View className="mt-6 rounded-2xl bg-white border border-border p-5 shadow-sm flex-row justify-between items-center">
        <View>
          ...
          <Text className="text-3xl font-black text-text-primary mt-1">₹350.00</Text>
        </View>
        <View className="h-12 w-12 items-center justify-center rounded-2xl bg-success/10">
          <Wallet size={24} color="#1FAC63" />
        </View>
      </View>
      ...
      <View className="mt-6 flex-row justify-between">
        <View className="w-[48%] rounded-2xl bg-white border border-border p-4 shadow-sm">
          ...
          <Text className="text-2xl font-black text-text-primary">12</Text>
          <Text className="text-xs font-bold text-text-secondary mt-1">Pending Exams</Text>
        </View>
        ...
        <View className="w-[48%] rounded-2xl bg-white border border-border p-4 shadow-sm">
          ...
          <Text className="text-2xl font-black text-text-primary">85%</Text>
      ...
      <View className="mt-8 mb-10">
        ...
        <TouchableOpacity className="flex-row items-center justify-between rounded-2xl bg-white border border-border p-4 shadow-sm mb-4">
          <View className="flex-row items-center flex-1 pr-4">
            ...
            <View className="flex-1">
              ...
              <Text className="text-xs text-text-muted mt-0.5">Starts tomorrow · 10:00 AM</Text>
            </View>
          </View>

  ...
  subjects: [
    {
      name: 'Mathematics',
      chapters: [
        { name: 'Real Numbers', topics: ['Euclid Division Lemma', 'Fundamental Theorem of Arithmetic', 'Irrational Numbers Proof', 'Decimal Expansions of Rationals'] },
        { name: 'Polynomials', topics: ['Zeros and Coefficients Relationship', 'Division Algorithm', 'Cubic Polynomials', 'Quadratic Polynomial Graphs'] },
        { name: 'Pair of Linear Equations', topics: ['Graphical Method', 'Substitution Method', 'Elimination Method', 'Cross-Multiplication Method'] },
        { name: 'Quadratic Equations', topics: ['Standard Form', 'Factorisation Method', 'Completing the Square', 'Discriminant and Nature of Roots'] },
        { name: 'Arithmetic Progressions', topics: ['General Term', 'Sum of First n Terms', 'Applications in Daily Life', 'Finding Missing Terms'] },
        { name: 'Triangles', topics: ['Basic Proportionality Theorem', 'Criteria of Similarity', 'Pythagoras Theorem', 'Tangent to Circle from External Point'] },
        { name: 'Coordinate Geometry', topics: ['Distance Formula', 'Section Formula', 'Area of Triangle', 'Collinearity of Points'] },
        { name: 'Introduction to Trigonometry', topics: ['Trigonometric Ratios', 'Trigonometric Identities', 'Complementary Angles', 'Trigonometric Tables'] },
        { name: 'Applications of Trigonometry', topics: ['Height and Distance', 'Angle of Elevation', 'Angle of Depression', 'Real-life Problems'] },
        { name: 'Circles', topics: ['Tangent to Circle', 'Number of Tangents from External Point', 'Angle in Alternate Segment', 'Cyclic Quadrilateral'] },
        { name: 'Areas Related to Circles', topics: ['Area of Sector', 'Area of Segment', 'Perimeter of Sectors', 'Combination of Figures'] },
        { name: 'Surface Areas and Volumes', topics: ['Combination of Solids', 'Conversion of Solids', 'Frustum of Cone', 'Volume of Combination'] },
        { name: 'Statistics', topics: ['Mean of Grouped Data', 'Mode and Median of Grouped Data', 'Cumulative Frequency Curve Ogive', 'Comparison of Measures'] },
        { name: 'Probability', topics: ['Classical Definition', 'Simple Problems', 'Cards and Dice Problems', 'Geometric Probability'] },
      ],
    },
    {
      name: 'Science',

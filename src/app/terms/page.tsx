            ...
            <div className="max-w-[1440px] mx-auto px-6 pt-12 pb-24 font-worksans">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-16">
                        <section>
                            <div className="flex items-center gap-4 mb-6 font-manrope">
                                ...
                                <h2 className="text-2xl font-black text-[#191c20]">1. Acceptance of Terms</h2>
                            </div>
                        ...
                        <section>
                            <div className="flex items-center gap-4 mb-6 font-manrope">
                                ...
                                <h2 className="text-2xl font-black text-[#191c20]">2. How to Use the Platform</h2>
                            </div>
                            <p className="text-lg text-gray-500 font-semibold leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-4 mb-6 font-manrope">
                                ...
                                <h2 className="text-2xl font-black text-[#191c20]">3. Payments & Plans</h2>
                            </div>
                            <p className="text-lg text-gray-500 font-semibold leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-4 mb-6 font-manrope">
                                ...
                                <h2 className="text-2xl font-black text-[#191c20]">4. Referral Rules</h2>
                            </div>
                            <p className="text-lg text-gray-500 font-semibold leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-4 mb-6 font-manrope">
                                ...
                                <h2 className="text-2xl font-black text-[#191c20]">5. Responsibility</h2>
                            </div>
                            <p className="text-lg text-gray-500 font-semibold leading-relaxed">
                    ...
                    <div className="mt-20 p-10 bg-[#f3f3fa] rounded-[40px] flex items-start gap-6">
                        ...
                        <div>
                            <h4 className="text-lg font-black text-[#191c20] mb-2 font-manrope">Fair Usage</h4>

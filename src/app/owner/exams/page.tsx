                ...
                <div style={{ padding: '32px', display: 'flex', flexDirection: 'column', gap: 28 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                        <div style={{ background: isActive ? P.successBg : P.hover, padding: '16px', borderRadius: 16, border: `1px solid ${isActive ? P.success : P.border}20`, textAlign: 'center' }}>
                            ...
                            <div style={{ fontSize: 16, fontWeight: 950, color: isActive ? P.success : P.muted }}>{isActive ? 'LIVE' : 'INACTIVE'}</div>
                        </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
                        {[
                            ...
                            { label: 'Questions', value: cfg?.total_questions ?? '0', color: P.brand, icon: Zap },
                            { label: 'Est. Revenue', value: exam.is_paid ? `₹${(exam.price * exam.attemptCount).toLocaleString()}` : '0', color: P.cta, icon: DollarSign },
                        ].map((c, idx) => (
                    ...
                    <div className="glass-card" style={{ border: `1px solid ${P.border}`, borderRadius: 20, padding: '24px' }}>
                        <h4 style={{ fontSize: 14, fontWeight: 900, color: P.dark, margin: '0 0 16px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Exam Setup</h4>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                            {[
                                { label: 'Time Limit', value: exam.duration ? exam.duration + ' Minutes' : 'Indefinite' },
                                { label: 'Negative Scoring', value: cfg?.negative_marking ? 'On' : 'Disabled' },
                                { label: 'Node Randomization', value: cfg?.randomization_mode ? (cfg.randomization_mode === 'all' ? 'Fully Randomized' : 'Shuffled') : 'Fixed Order' },
                                { label: 'Access Rules', value: exam.allow_anytime ? 'Open Access' : 'Scheduled' },
                            ].map((row, i) => (
                    ...
                    {exam.description && (
                        <div className="glass-card" style={{ border: `1px solid ${P.border}`, borderRadius: 20, padding: '24px' }}>
                            <h4 style={{ fontSize: 13, fontWeight: 900, color: P.muted, margin: '0 0 12px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Description</h4>
            ...
            <header style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 40 }}>
                <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                        <div style={{ background: P.brandBg, padding: '4px 12px', borderRadius: 8, fontSize: 11, fontWeight: 900, color: P.brand, textTransform: 'uppercase', letterSpacing: '0.08em' }}>Syllabus &amp; Exams</div>
                        <div style={{ width: 4, height: 4, borderRadius: '50%', background: P.border }} />
                        <div style={{ fontSize: 13, color: P.muted, fontWeight: 600 }}>Platform Exam Overview</div>
                    </div>
                    <h1 style={{ fontSize: 36, fontWeight: 950, color: P.dark, margin: 0, letterSpacing: '-0.04em' }}>Exam Oversight</h1>
                    <p style={{ fontSize: 15, color: P.muted, margin: '8px 0 0', fontWeight: 600 }}>See and review all exams created by tenants. Monitor attempts, scores, and any cheat alerts.</p>
                </div>
                    ...
                    {activeTab === 'exams' && (
                        <>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
                                <MetricCard icon={BookOpen} label="Total Exams" value={String(s?.totalExams ?? 0)} sub={(s?.paidExams ?? 0) + ' Paid  •  ' + (s?.freeExams ?? 0) + ' Free'} color={P.brand} bg={P.brandBg} />
                                <MetricCard icon={Users} label="Total Attempts" value={String(s?.totalAttempts ?? 0)} sub={(s?.evaluatedAttempts ?? 0) + ' Evaluated'} color={P.info} bg={P.infoBg} />
                            ...
                            <div style={{ background: P.card, border: '1px solid ' + P.border, borderRadius: 14, padding: '14px 18px', marginBottom: 20, display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                                ...
                                <div style={{ display: 'flex', gap: 4, background: P.bg, border: '1px solid ' + P.border, borderRadius: 10, padding: 4 }}>
                                    {[{ k: 'all', l: 'All' }, { k: 'free', l: 'Free' }, { k: 'paid', l: 'Paid' }].map(f => (
                            ...
                            <div style={{ background: P.card, border: '1px solid ' + P.border, borderRadius: 16, overflow: 'hidden' }}>
                                {(data?.exams?.length ?? 0) === 0 ? (
                                    <div style={{ padding: '80px 40px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
                                        ...
                                        <div>
                                            <div style={{ fontSize: 22, fontWeight: 950, color: P.dark, marginBottom: 8, letterSpacing: '-0.02em' }}>No Exams Found</div>
                                                ...
                                                <thead>
                                                    <tr style={{ background: P.bg, borderBottom: '2px solid ' + P.border }}>
                                                        <th style={{ padding: '18px 24px', textAlign: 'left', fontSize: 12, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' }}>
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><BookOpen size={13} /> Exam Name</div>
                                                        </th>
                                                        <th style={{ padding: '18px 24px', textAlign: 'left', fontSize: 12, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' }}>
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><School size={13} /> Tenant</div>
                                                        </th>
                                                        <th style={{ padding: '18px 24px', textAlign: 'left', fontSize: 12, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' }}>
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><DollarSign size={13} /> Type</div>
                                                        </th>
                                                        <th style={{ padding: '18px 24px', textAlign: 'left', fontSize: 12, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' }}>
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><Settings size={13} /> Details</div>
                                                        </th>
                                                        <th style={{ padding: '18px 24px', textAlign: 'left', fontSize: 12, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' }}>
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><Users size={13} /> Attempts</div>
                                                        </th>
                                                        <th style={{ padding: '18px 24px', textAlign: 'left', fontSize: 12, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' }}>
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><ShieldAlert size={13} /> Cheat Alerts</div>
                                                        </th>
                                                        <th style={{ padding: '18px 24px', textAlign: 'left', fontSize: 12, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' }}>
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><Calendar size={13} /> Schedule</div>
                                                        </th>
                                                        <th style={{ padding: '18px 24px', textAlign: 'left', fontSize: 12, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' }}>Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                                ...
                                                                >
                                                                    <td style={{ padding: '20px 24px' }}>
                                                                        ...
                                                                        {isLive && (
                                                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }}>
                                                                                ...
                                                                                <span style={{ fontSize: 11, fontWeight: 850, color: P.success }}>LIVE</span>
                                                                            </div>
                                                                        )}
                                                                    </td>
                                                                    <td style={{ padding: '20px 24px' }}>
                                                                    ...
                                                                    <td style={{ padding: '20px 24px' }}>
                                                                        <div style={{ fontSize: 13, color: P.dark, fontWeight: 750 }}>
                                                                            {cfg?.total_questions ? cfg.total_questions + ' Questions' : '—'}
                                                                        </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 24 }}>
                                ...
                                <div className="glass-card" style={{ border: '1px solid ' + P.border, borderRadius: 24, padding: '28px 32px' }}>
                                    <div style={{ marginBottom: 24 }}>
                                        <div style={{ fontSize: 11, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 6 }}>Monthly Exam Activity</div>
                                        <h3 style={{ fontSize: 22, fontWeight: 950, color: P.dark, margin: 0, letterSpacing: '-0.02em' }}>New Exams Per Month</h3>
                                    </div>
                                ...
                                <div className="glass-card" style={{ border: '1px solid ' + P.border, borderRadius: 24, padding: '28px 32px' }}>
                                    <div style={{ marginBottom: 20 }}>
                                        <div style={{ fontSize: 11, fontWeight: 900, color: P.muted, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 6 }}>Exam Type Split</div>
                                        <h3 style={{ fontSize: 22, fontWeight: 950, color: P.dark, margin: 0, letterSpacing: '-0.02em' }}>Free vs Paid</h3>
                                    </div>
                                    {pieData.length === 0 ? (

            ...
            {step === 'config' ? (
                <div>
                    ...
                    <div style={{ 
                        ...
                        <div>
                            <div style={{ fontSize: 14, fontWeight: 700, color: '#1B1D21' }}>Detailed Mode (AI-Powered)</div>
                            <div style={{ fontSize: 11, color: '#A5A2A6' }}>AI will create distinct subjects and detailed topics per class level.</div>
                        </div>
                        <button 
                ...
                <div>
                 ...
                 <div style={{ textAlign: 'center', padding: '40px 0' }}>
                    ...
                    <h3 style={{ fontSize: 18, fontWeight: 800, margin: '0 0 8px' }}>Saving...</h3>
                 </div>
            ) : (

...
// Get translated options for a question in the given language
function getOptions(q: any, lang: string): string[] {
    if (!q) return []
    // options can be { en: [...], hi: [...], gu: [...] } or plain array
...
export default function StudentExamAttempt() {
    ...
    // Alternate languages = all languages except the current exam language
    ...
    return (
        <div style={{ position: 'fixed', inset: 0, background: '#0F172A', display: 'flex', flexDirection: 'column', color: '#FFF', zIndex: 50 }}>
            ...
            <div style={{ height: 80, background: '#1E293B', borderBottom: '1px solid #334155', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 40px', zIndex: 10, flexShrink: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
                    ...
                    <div>
                        ...
                        <div style={{ fontSize: 11, fontWeight: 700, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Secure Examination · {LANG_LABELS[examLang]}</div>
                    </div>
                </div>
            ...
            <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
                ...
                <div style={{ width: 300, background: '#111827', borderRight: '1px solid #1E293B', padding: 32, overflowY: 'auto', flexShrink: 0 }}>
                    <h4 style={{ margin: '0 0 20px', fontSize: 12, fontWeight: 800, color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Question Palette</h4>

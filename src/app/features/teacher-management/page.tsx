...
import {
    UserCheck, Users, ShieldCheck, CheckCircle, ArrowRight,
    Sparkles, Key, Layers, BookOpen, Building
} from 'lucide-react'
            ...
            <main style={{ flex: 1 }}>
                ...
                <section style={{ position: 'relative', padding: '90px 5% 70px', background: 'linear-gradient(135deg, #1E3A8A 0%, #172554 100%)', color: '#FFFFFF', overflow: 'hidden', textAlign: 'center' }}>
                    ...
                    <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 10 }}>
                        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(255, 255, 255, 0.12)', border: '1px solid rgba(255, 255, 255, 0.2)', padding: '6px 16px', borderRadius: 999, fontSize: 12, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: '#93C5FD', marginBottom: 20 }}>
                            <UserCheck size={14} /> Feature Highlight · Teacher Management
                        </div>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 14 }}>
                            ...
                            >
                                Demo Faculty Console <ArrowRight size={16} />
                            </Link>
                            <Link
                                href="/pricing"
                                style={{
                    ...
                    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                        <div style={{ textAlign: 'center', marginBottom: 56 }}>
                            ...
                            <h2 style={{ fontSize: 'clamp(24px, 3vw, 38px)', fontWeight: 800, color: '#0F172A', fontFamily: 'var(--font-manrope, sans-serif)' }}>
                                Efficient Governance for Teaching Staff & Mentors
                            </h2>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    title: 'Role-Based Permission Controls',
                                    desc: 'Assign specific permissions for Head Teachers, Subject Faculties, Exam Coordinators, and Evaluation Assistants.',
                                    bullets: [
                                        'Custom role creation (Create, Edit, Publish, Grade)',
                                ...
                                {
                                    icon: BookOpen,
                                    badge: 'Class Assignments',
                                    title: 'Subject & Batch Allocation',
                                    desc: 'Map teachers to specific classes, subjects, and student batches for tailored exam setting and progress tracking.',
                                    bullets: [
                                        'Multi-subject teacher profile mapping',
                                ...
                                {
                                    icon: Layers,
                                    badge: 'Workload Tracker',
                                    title: 'Faculty Workload & Activity Audits',
                                    desc: 'Monitor question paper creation volume, evaluation turnaround speeds, and active class engagement stats.',
                                    bullets: [
                                        'Teacher paper creation volume metrics',
                                        'Grading turnaround speed tracking',
                                        'Detailed audit logs for administrative reviews'
                                    ],
                                    color: '#7C3AED',
                                    bg: '#F3E8FF'
                                },
                                {
                                    icon: Building,
                                    badge: 'Multi-Branch Staff',
                                    title: 'Cross-Branch Faculty Operations',
                                    desc: 'Manage teaching staff deployed across multiple campus centers with unified central administration controls.',
                                    bullets: [
                                        'Multi-campus teacher roster management',
                                        'Centralized faculty performance comparison',
                                        'Instant bulk account provisioning & password reset'
                                    ],
                                    color: '#D97706',
                                    bg: '#FEF3C7'
                                }
                ...
                <section style={{ padding: '70px 5%', background: '#1E3A8A', color: '#FFFFFF', textAlign: 'center' }}>
                    <div style={{ maxWidth: 750, margin: '0 auto' }}>
                        ...
                        >
                            Request Teacher Suite Demo <ArrowRight size={16} />
                        </Link>
                    </div>
                </section>

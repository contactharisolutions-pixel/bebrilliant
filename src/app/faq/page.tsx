            ...
            <div className="max-w-[1440px] mx-auto px-6 pt-12 pb-24 font-worksans">
                <div className="max-w-3xl mx-auto space-y-4">
                    {FAQS.map((faq, i) => (
                        <div 
                            key={i} 
                            className={`group transition-all duration-300 rounded-[32px] overflow-hidden ${openIndex === i ? 'bg-white shadow-2xl shadow-gray-200/50' : 'bg-[#f3f3fa]/70 hover:bg-[#ededf4]'}`}
                        >
                            <button 
                            ...
                            >
                                <div className="px-8 pb-8 text-lg text-gray-500 font-semibold leading-relaxed pt-2 mt-2">
                                    {faq.a}
                                </div>
                            </div>
                        </div>
                ...
                <section className="mt-20 md:mt-24 bg-gradient-to-br from-[#0B1220] to-[#183754] rounded-[64px] p-16 md:p-24 relative overflow-hidden text-center md:text-left">
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                        <div className="md:max-w-xl">
                            <div className="flex items-center justify-center md:justify-start gap-4 mb-8 text-[#79f8a6]">
                                <HelpCircle size={32} />
                                <span className="text-sm font-black uppercase tracking-[0.2em] font-manrope">Still have questions?</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-black text-white mb-8 leading-tight font-manrope" style={{ letterSpacing: '-0.02em' }}>We’re here to <br />support your journey.</h2>
                            <p className="text-xl text-white/55 font-semibold leading-relaxed mb-10">
                        ...
                        <div className="bg-white/5 backdrop-blur-xl border border-white/5 p-12 rounded-[48px] text-center hidden lg:block">
                            <div className="text-6xl font-black text-[#79f8a6] mb-2 tracking-tighter font-manrope">99.9%</div>
                            <div className="text-sm font-black text-white/40 uppercase tracking-[0.2em] font-manrope">Uptime Guarantee</div>
                            <div className="w-full h-[1px] bg-white/10 my-8" />
                            <div className="text-6xl font-black text-[#79f8a6] mb-2 tracking-tighter font-manrope">24/7</div>
                            <div className="text-sm font-black text-white/40 uppercase tracking-[0.2em] font-manrope">Partner Support</div>
                        </div>
                    </div>
                </section>
            </div>

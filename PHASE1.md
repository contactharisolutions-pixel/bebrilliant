...
### `.env.local` (Frontend)
```
NEXT_PUBLIC_SUPABASE_URL=https://mtoslybnnywmsmpwjphv.supabase.co
NEXT_PUBLIC_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im10b3NseWJubnl3bXNtcHdqcGh2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyNzkzODUsImV4cCI6MjA5MTg1NTM4NX0.HNfd1KC2BLM-BdMBRa5rNHaZYAzbRwtOacqjuNZuPdI
```

### `.env` (Backend)
```
SUPABASE_URL=https://mtoslybnnywmsmpwjphv.supabase.co
SUPABASE_SERVICE_ROLE_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im10b3NseWJubnl3bXNtcHdqcGh2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NjI3OTM4NSwiZXhwIjoyMDkxODU1Mzg1fQ.30e1Y01PB87lmBZykE84W_QMcXiHK0uH1vpck-SlJgE
DATABASE_URL=postgresql://postgres:Life%4020242526@db.mtoslybnnywmsmpwjphv.supabase.co:5432/postgres
```
